...
public class MovingCube : MonoBehaviour {
	...
	[SerializeField]
	Transform transformCamera = default;
	...
	void Update () {
		...
		if (transformCamera) {
			rightAxis = ProjectDirectionOnPlane(transformCamera.right, upAxis);
			forwardAxis = ProjectDirectionOnPlane(transformCamera.forward, upAxis);
		}
		else {

...
namespace HEXLIBRIUM
{
    ...
    public class H13 : State
    {
        private void OnEnable()
        {
            ...
            StateMachineManager.instance.heroJourney.gameObject.SetActive(false);
            StateMachineManager.instance.helements.gameObject.SetActive(true);

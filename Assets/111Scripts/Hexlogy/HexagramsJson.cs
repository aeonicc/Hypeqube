...
public class HexagramsJson
{
    // public string name;
    // public int power;
    //
    // public Hexagrams(string newName, int newPower)
    // {
    //     name = newName;
    //     power = newPower;
    // }
    ...
    // void Start()
    // {
    //     //List<Hexagrams> hexagrams = new List<Hexagrams>();
    //     //hexagrams.Add(new Hexagrams(""The Dragon"", 01));
    //
    //     //Dictionary<string, Hexagrams> hexagrams = new Dictionary<string, Hexagrams>();
    //
...
//hexagrams = [{
    ...
    public const string HexagramLibrary = @"
        {
